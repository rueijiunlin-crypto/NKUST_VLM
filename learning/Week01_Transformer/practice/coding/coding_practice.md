...
| --- | --- | --- | --- |
| 1 | `guided_demos/01_token_embedding_reading.py` | 文字到 Embedding | 待填 |
| 2 | `guided_demos/02_position_encoding_reading.py` | 加入位置資訊 | 待填 |
| 3 | `guided_demos/03_qkv_reading.py` | 線性投影產生 Q、K、V | 待填 |
| 4 | `guided_demos/04_self_attention_reading.py` | 分數、權重與上下文 | 待填 |
| 5 | `guided_demos/05_multi_head_attention_reading.py` | 拆 head 與合併 head | 待填 |
| 6 | `guided_demos/06_encoder_decoder_reading.py` | Encoder memory 與 Decoder 取用 | 待填 |
