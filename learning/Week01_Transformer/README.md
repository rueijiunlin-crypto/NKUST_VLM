...
- [`practice/README.md`](./practice/README.md)：本週練習總入口。
- `demo/` 是完整可執行範例，用來觀察概念、輸入輸出與中間結果。
- `practice/concept/` 是觀念練習與觀念參考答案。
- `practice/coding/exercises/` 是學生實際補程式碼的練習檔。
- `practice/coding/solutions/` 與 answer key（參考答案）檔案是參考答案，請完成練習後再查看。
