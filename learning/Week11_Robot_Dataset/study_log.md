...
| 日期 | Dataset／Episode | Schema 檢查 | Alignment／Split 觀察 | 疑問 |
| --- | --- | --- | --- | --- |
|  |  |  |  |  |
...
## Real Dataset Record（學生填寫）

| Repository / Revision | Episode / Task | Image / State / Action Shape | License / Cache | Failure / Summary |
|---|---|---|---|---|
|  |  |  |  |  |
