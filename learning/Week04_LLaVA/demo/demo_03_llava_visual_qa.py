...
def main():
    ...
    print(f"model={args.model_id} revision={args.revision} device={device_map} dtype={args.dtype}")
    ...
    print(f"inference_seconds={elapsed:.3f} output_tokens={generated.shape[1]}")
