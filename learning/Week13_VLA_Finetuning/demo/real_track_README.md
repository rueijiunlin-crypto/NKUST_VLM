...
- Official source：[SmolVLA training documentation](https://github.com/huggingface/lerobot/blob/main/docs/source/smolvla.mdx)。
...
- Target versions — verify before execution：官方 LeRobot release/commit 與其 CUDA PyTorch lockfile；本機未安裝 `lerobot-train`。
